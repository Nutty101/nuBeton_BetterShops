...
public class NUBetterShops_Condition extends Condition
{
	private final String sBetterShop;

	public NUBetterShops_Condition(String packName, String instruction) throws InstructionParseException
	{
